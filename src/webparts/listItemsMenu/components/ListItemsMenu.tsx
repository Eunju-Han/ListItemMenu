...
// const { getGroupHeaders, getField } = useList();
...
// import * as React from 'react';
// import styles from './ListItemsMenu.module.scss';
// import { IListItemsMenuProps } from './IListItemsMenuProps';
// import { escape } from '@microsoft/sp-lodash-subset';

// export default class ListItemsMenu extends React.Component<IListItemsMenuProps, {}> {
//   public render(): React.ReactElement<IListItemsMenuProps> {
//     return (
//       <div className={styles.listItemsMenu}>
